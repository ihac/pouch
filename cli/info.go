...
func prettyPrintInfo(cli *Cli, info *types.SystemInfo) error {
	...
	fmt.Fprint(fos.Stdout, "HTTPS Proxy: %s\n", info.HTTPSProxy)
	fmt.Fprint(fos.Stdout, "Registry: %s\n", info.IndexServerAddress)
	fmt.Fprint(fos.Stdout, "Experimental: %v\n", info.ExperimentalBuild)
	fmt.Fprint(fos.Stdout, "Debug: %v\n", info.Debug)
	...
	fmt.Fprintf(os.Stdout, "Daemon Listen Addresses: %s\n", info.ListenAddresses)
